...
public class TelegramBotService extends TelegramLongPollingBot {
    ...
    @Autowired
    private MongoServiceRESTInvoker mongoServiceInvoker;

    public void sendMessage(String text) {
        List<SubscriberDTO> subscribers = mongoServiceInvoker.findAllSubscribers();
    ...
    private void handleSubscribe(Message message) {
        ...
        mongoServiceInvoker.createSubscriber(chatId, username);
